...
def user_login():
    ...
    with open(DATA_FILE, 'r') as data:
        for line in data:
            First_name, Second_name, mail, Password = line.strip().split(',') ##First и Second nam'ы негде использовать, но они нужны чтобы программа правильно распаковала данные 
            if mail == usermail and Password == password_check:
